<?php
define('INSTALLFILE', 'rsvpforminstall.php');
define('CONFIGFILE', 'rsvpformsettings.php');
define('ABSPATH', dirname(__FILE__) . '/' );

error_reporting( E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_ERROR | E_WARNING | E_PARSE | E_USER_ERROR | E_USER_WARNING | E_RECOVERABLE_ERROR );

$install_complete = '<br />Installation complete. <a href="rsvpform.htm">Visit your form</a>. <br /><br />To reinstall, delete the file: '.CONFIGFILE.' then run <a href="'.INSTALLFILE.'">this installer again</a>.<br /><br />';
...
<html>
	...
	<link rel="stylesheet" type="text/css" href="rsvpform.css">
	<style>.freecontactform {width: 460px;font-size:12px}</style>
	</head>
	<body>
	<div align="center"><br />
	<div class="rsvpform">
	<div class="rsvpformheader">Installation Form</div>
...
switch($step) {
  ...
  case "1":
      ...
      ?>
      		...
      		<script src="rsvpformvalidation.js"></script>
			<script>
			...
			<form name="rsvpform" method="post" action="<?php echo INSTALLFILE; ?>" onsubmit="return validate.check(this)">
			<input type="hidden" name="step" value="2">
			<table width="450px">
			<tr>
			 <td colspan="2">
			 
			 <div class="rsvpformmessage">
			...
			<tr>
			 ...
			 <td valign="top">
			  <input type="text" name="subject" id="subject" maxlength="100" value="RSVP Form" style="width:140px"> + Forms Subject
			 </td>
			 </tr>
			...
			<tr>
			 ...
			 <td valign="top">
			  <input type="text" name="answer" id="answer" maxlength="100" value="8" style="width:180px">
			 </td>
